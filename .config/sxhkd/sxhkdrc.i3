...
# screenshot whole display using maim
@Print
 maim ~/Pictures/$(date +%s).png | dunstify "Screenshot Captured" "Saved to ~/Pictures/$(date +%s).png"

# select region, copy to clipboard
# super + Print
 # maim -s -u | xclip -selection clipboard -t image/png
super + {_,shift + } Print
 {flameshot gui,maim -s -u | xclip -selection clipboard -t image/png}
